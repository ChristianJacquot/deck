...
func (crud *developerPostAction) Create(args ...crud.Arg) (crud.Arg, error) {
	return nil, crud.currentState.Developers.Add(*args[0].(*state.Developer))
}

func (crud *developerPostAction) Delete(args ...crud.Arg) (crud.Arg, error) {
	return nil, crud.currentState.Developers.Delete(*((args[0].(*state.Developer)).ID))
}

func (crud *developerPostAction) Update(args ...crud.Arg) (crud.Arg, error) {
